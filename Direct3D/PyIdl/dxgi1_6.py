...
DXGI_ADAPTER_FLAG3_NONE                         = DXGI_ADAPTER_FLAG3(0).value
DXGI_ADAPTER_FLAG3_REMOTE                       = DXGI_ADAPTER_FLAG3(1).value
DXGI_ADAPTER_FLAG3_SOFTWARE                     = DXGI_ADAPTER_FLAG3(2).value
DXGI_ADAPTER_FLAG3_ACG_COMPATIBLE               = DXGI_ADAPTER_FLAG3(4).value
DXGI_ADAPTER_FLAG3_SUPPORT_MONITORED_FENCES     = DXGI_ADAPTER_FLAG3(8).value
DXGI_ADAPTER_FLAG3_SUPPORT_NON_MONITORED_FENCES = DXGI_ADAPTER_FLAG3(0x10).value
DXGI_ADAPTER_FLAG3_KEYED_MUTEX_CONFORMANCE      = DXGI_ADAPTER_FLAG3(0x20).value
DXGI_ADAPTER_FLAG3_FORCE_DWORD                  = DXGI_ADAPTER_FLAG3(0xFFFFFFFF).value

DXGI_GPU_PREFERENCE = ctypes.c_uint
DXGI_GPU_PREFERENCE_UNSPECIFIED      = DXGI_GPU_PREFERENCE(0).value
DXGI_GPU_PREFERENCE_MINIMUM_POWER    = DXGI_GPU_PREFERENCE().value
DXGI_GPU_PREFERENCE_HIGH_PERFORMANCE = DXGI_GPU_PREFERENCE().value

DXGI_HARDWARE_COMPOSITION_SUPPORT_FLAGS = ctypes.c_uint
DXGI_HARDWARE_COMPOSITION_SUPPORT_FLAG_FULLSCREEN       = DXGI_HARDWARE_COMPOSITION_SUPPORT_FLAGS(1).value
DXGI_HARDWARE_COMPOSITION_SUPPORT_FLAG_WINDOWED         = DXGI_HARDWARE_COMPOSITION_SUPPORT_FLAGS(2).value
